...
class ContactMenu extends React.Component {
  ...
  handleToggle = () => {
    ...
    {
      this.state.open?
      document.getElementById("border5").removeAttribute("class", "borderBottom5"): document.getElementById("border5").setAttribute("class", "borderBottom5");
    }
    {
  ...
  handleClose = event => {
    ...
    document.getElementById("border5").removeAttribute("class", "borderBottom5");
