...
class ContactMenu extends React.Component {
  ...
  handleToggle = () => {
    ...
    {
      this.state.open?
      document.getElementById("border1").removeAttribute("class", "borderBottom1"): document.getElementById("border1").setAttribute("class", "borderBottom1");
  ...
  handleClose = event => {
    ...
    document.getElementById("border1").removeAttribute("class", "borderBottom1");
                      ...
                      <MenuList className={classes.container}>
                        {
                          this.props.subMenus.map((menu, index) => {
                            return <MyButton key={index} icon={menu.icon} label={menu.label} href={menu.to || ""} onClick={menu.onClick}/>                  
                          })
                        }
