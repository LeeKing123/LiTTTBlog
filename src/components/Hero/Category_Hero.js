        ...
        <section className="hero">
          <div className={classes.header}>
            <div className={classes.breadcrumb}>
              {/* <Link to={'/'} className={classes.breadcrumbLink}>Home</Link> » <Link to={'/category/'} className={classes.breadcrumbLink}>{category}</Link> */}
            </div>
            {/* <header>
...
export default withStyles(styles) (CategoryHero);
